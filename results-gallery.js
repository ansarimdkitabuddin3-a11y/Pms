/* ============================================================
   results-gallery.js — Prakash Model School
   HOW TO ADD PHOTOS:
...
const PHOTOS = [
  ...
  // { src: "https://your-image-url.jpg", label: "Caption here" },
  // Example:
  // { src: "https://i.imgur.com/abc123.jpg", label: "Class 12 Toppers 2024" },
...
(function () {
  ...
  // If no photos yet — show a friendly message
  if (photos.length === 0) {
    grid.innerHTML = `
      <div style="text-align:center;padding:60px 20px;color:#94a3b8">
        <i class="fas fa-image" style="font-size:3rem;margin-bottom:16px;display:block;opacity:.4"></i>
        <p style="font-size:1rem;font-weight:500">Photos coming soon!</p>
        <p style="font-size:.82rem;margin-top:6px;opacity:.7">Add image URLs in results-gallery.js to display them here.</p>
      </div>`;
    return;
  }
